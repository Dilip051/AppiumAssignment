...
public class LongPressreal {
	WebDriver driver;
	@Test
public void lpress(WebElement element) throws MalformedURLException, InterruptedException {
    ...
    longPressOptions.withElement(ElementOption.element(element))
                   .withDuration(Duration.ofSeconds(2)); // Set the duration of long press
